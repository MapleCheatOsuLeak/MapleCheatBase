...
void UI::render()
{
	if ((MainMenu::GetIsVisible()) && !rawInputDisabled)
		disableRaw();
	else if (!MainMenu::GetIsVisible() && rawInputDisabled)
		enableRaw();
	...
	//if (Config::Visuals::UI::Snow && (MainMenu::GetIsVisible()))
